export const SURAH_DATA = [
  ...
  { number: 5, name: "Al-Ma'idah", englishName: "The Table Spread", verses: 120 },
  ...
  { number: 13, name: "Ar-Ra'd", englishName: "The Thunder", verses: 43 },
  ...
  { number: 23, name: "Al-Mu'minun", englishName: "The Believers", verses: 118 },
  { number: 24, name: "An-Nur", englishName: "The Light", verses: 64 },
  { number: 25, name: "Al-Furqan", englishName: "The Criterion", verses: 77 },
  { number: 26, name: "Ash-Shu'ara", englishName: "The Poets", verses: 227 },
  ...
  { number: 37, name: "As-Saffat", englishName: "Those who set the Ranks", verses: 182 },
  { number: 38, name: "Sad", englishName: "The Letter Saad", verses: 88 },
  { number: 39, name: "Az-Zumar", englishName: "The Troops", verses: 75 },
  ...
  { number: 46, name: "Al-Ahqaf", englishName: "The Wind-Curved Sand Dunes", verses: 35 },
  ...
  { number: 56, name: "Al-Waqi'ah", englishName: "The Inevitable", verses: 96 },
  ...
  { number: 61, name: "As-Saff", englishName: "The Ranks", verses: 14 },
  { number: 62, name: "Al-Jumu'ah", englishName: "The Congregation", verses: 11 },
  ...
  { number: 70, name: "Al-Ma'arij", englishName: "The Ascending Stairways", verses: 44 },
  ...
  { number: 79, name: "An-Nazi'at", englishName: "Those who drag forth", verses: 46 },
  ...
  { number: 84, name: "Al-Inshiqaq", englishName: "The Splitting Open", verses: 25 },
  { number: 85, name: "Al-Buruj", englishName: "The Mansions of the Stars", verses: 22 },
  { number: 86, name: "At-Tariq", englishName: "The Nightcommer", verses: 17 },
  { number: 87, name: "Al-A'la", englishName: "The Most High", verses: 19 },
  ...
  { number: 101, name: "Al-Qari'ah", englishName: "The Calamity", verses: 11 },
  ...
  { number: 107, name: "Al-Ma'un", englishName: "The Small Kindnesses", verses: 7 },
...
export function getSurahByNumber(number: number) {
  return SURAH_DATA.find(surah => surah.number === number);
}

export function getSurahByName(name: string) {
  return SURAH_DATA.find(surah => surah.name.toLowerCase() === name.toLowerCase());
}
