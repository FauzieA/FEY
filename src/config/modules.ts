...
export const MODULES: ModuleDefinition[] = [
  ...
  { id: "character", label: "Character", path: "/character", icon: User, tagline: "Who I am becoming", primary: true },
  { id: "progress", label: "Progress", path: "/progress", icon: LineChart, tagline: "Long-term trends", primary: true },
];
